...
export const typeProductDetails: Record<CityType, [CityProduct, CityProduct, CityProduct]> = {
  ...
  hospitality: [
    ...
    },
    {
      ...
      name: "Rolltainers",
      tagline: "Stainless steel laundry trolleys for efficient linen collection from chute base stations.",
    },
    {
      slug: "scent-diffuser",
  ...
  industrial: [
    {
      slug: "skip-bins",
      href: "/products/skip-bins",
      name: "Skip Bins",
      tagline: "Crane-liftable, skip-truck compatible containers in 5, 7 and 10 m³ capacities.",
    },
    {
      slug: "static-compactor",
      href: "/products/static-compactor",
      name: "Static Compactors",
      tagline: "Heavy-duty hydraulic compactors for medium to very high-volume commercial waste.",
    },
    {
      slug: "self-tipping-skips",
      href: "/products/self-tipping-skips",
      name: "Self-Tipping Skips",
      tagline: "Safe, controlled tipping for heavy metal waste, press burrs and abrasive materials.",
    },
  ],
  general: [
    {
    ...
    },
    {
      ...
      href: "/products/skip-bins",
      name: "Skip Bins",
      tagline: "Heavy-duty skip containers in 5, 7 and 10 m³ — crane-liftable and skip-truck compatible.",
    },
    {
      slug: "bin-tipper",
      href: "/products/bin-tipper",
      name: "Bin Tippers",
      tagline: "Ergonomic bin emptying for 120L–1100L bins — manual, electric and battery models.",
    },
  ],
};
